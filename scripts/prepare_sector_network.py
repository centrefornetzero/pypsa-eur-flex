...
def add_heat(
    ...
    for heat_system in (
        ...
        #### Adding in a lot more heating storage: modelled after pypsa fes setup 
        ...
        if options.get('additional_hot_water_tanks'): #adding longer water tanks, specifically connected to the low voltage network
            ...
            number_houses_with_additional_tanks = options['number_households']
            ...
            n.add(
                ...
                bus=nodes + f" {heat_system} water tanks",
                e_nom=0.006 * number_houses_with_additional_tanks, #need to multiply by number of households, right now this is negligeable
